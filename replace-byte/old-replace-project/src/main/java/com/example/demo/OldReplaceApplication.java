...
public class OldReplaceApplication implements CommandLineRunner {

    public OldReplaceApplication(RedisTemplate<Object, Object> redisTemplate) {
        this.redisTemplate = redisTemplate;
    }

    public static void main(String[] args) {
        SpringApplication.run(OldReplaceApplication.class, args);
    }
